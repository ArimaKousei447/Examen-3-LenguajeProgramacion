...
namespace datos
{
    ...
    {
        string cadena = "server=localhost; user=root; database=ticketbd; password=12345;";
        ...
        public ticked Autenticar(login login)
        {
            ...
            try
            {
                ...
                sql.Append("SELECT * FROM tickets WHERE usuario = @usuario  AND contrasena = @contrasena;");
